export const Faqs = [
  ...
  },
  {
    ...
    desc: "",
    top_desc: "Review your Display Name and:",
    points: [
      "Remove any extra prohibited characters, especially consecutive ones.",
      "Ensure the name contains at least one letter or number.",
      "Choose a different name if it contains restricted words like admin.",
    ],
    type: "bullets",
  },
  {
    ...
    desc: `The "Send" button will only light up once your input sequence is valid and follows all the rules.`,
  },
  ...
  },
  {
    ...
    desc: "Yes, you can disable Project Mode by typing /project off. However, this will not restore the cleared chat data from before Project Mode was enabled.",
  },
  {
    id: 19,
  ...
  },
  {
    ...
    points: [
      "Enabling Project Mode clears all existing messages in the chat.",
      "Once enabled, Project Mode settings cannot be reverted without starting a new session.",
      "Ensure all participants are aware of this change before proceeding.",
    ],
    desc: "",
    type: "bullets",
  },
  ...
  },
  {
    ...
    desc: "Disabling Project Mode (/project off) stops its enhanced features, but it does not restore previously cleared messages. A new session may need to be created for fresh settings.",
  },
...
export const messageType = {
  ...
  PROJECT_MODE_EXIT: "PROJECT_MODE_EXIT",
